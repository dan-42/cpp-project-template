#ifndef PRE_XML_DETAIL_SFINAE_ENABLER_HPP
#define PRE_XML_DETAIL_SFINAE_ENABLER_HPP
...
#include <pre/xml/traits/is_boost_variant.hpp>
#include <pre/xml/traits/is_container.hpp>
#include <pre/xml/traits/is_associative_container.hpp>
#include <pre/xml/traits/is_string.hpp>
...
namespace pre { namespace xml { namespace detail {
    ...
    template<class T>
    using enable_if_is_string_t = typename std::enable_if<
